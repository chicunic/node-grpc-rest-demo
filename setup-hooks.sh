...
echo -e "  • ${YELLOW}pre-commit${NC}: Type check + Biome check (format & lint) + security check"
echo -e "  • ${YELLOW}pre-push${NC}: Type check + Biome check + security checks for all branches, plus build + tests for staging/production"
echo ""
