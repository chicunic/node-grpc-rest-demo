...
echo -e "  • ${YELLOW}pre-commit${NC}: Code quality check (format, lint, typecheck) + security check"
echo -e "  • ${YELLOW}pre-push${NC}: Code quality + security checks for all branches, plus build + tests for staging/production"
echo ""
