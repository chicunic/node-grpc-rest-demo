...
echo -e "  • ${YELLOW}pre-commit${NC}: Type check + lint (format & lint) + security check"
echo -e "  • ${YELLOW}pre-push${NC}: Type check + lint + security checks for all branches, plus build + tests for staging/production"
echo ""
